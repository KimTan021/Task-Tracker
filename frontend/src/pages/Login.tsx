      ...
      <section className="w-full lg:w-[45%] bg-[var(--color-surface-container-lowest)] flex items-center justify-center p-8 md:p-16 relative">
        <div className="w-full max-w-md animate-fade-in-up delay-200">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3 transform transition-all duration-500 hover:translate-x-1 delay-100">
              <div className="flex justify-between items-end">
                ...
                <button type="button" disabled title="Password recovery is not available yet" className="text-label-sm font-bold text-[var(--color-on-surface-variant)]/40 uppercase tracking-widest cursor-not-allowed">
                  Forgot password?
                </button>
              </div>
              <Input 
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" disabled title="SSO is not configured yet" className="flex cursor-not-allowed items-center justify-center space-x-3 py-4 px-4 rounded-xl bg-[var(--color-surface-container-low)] text-[var(--color-on-surface)]/55 font-display font-bold">
