...
public interface ProjectService {
    ...
    void deleteProjectById(Integer projectId, String requesterEmail);
    ...
    java.util.List<ProjectMemberResponseDTO> getMembers(Integer projectId);
    void removeMember(Integer projectId, Integer userId, String requesterEmail);
    void promoteMember(Integer projectId, Integer userId, String requesterEmail);
